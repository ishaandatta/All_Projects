...
from utils import get_display_id, log_to_file, get_hostname, demo_print, debug_print
...
class MembershipList:
    ...
    # add a node to this membership list
    ...
    # update the state of a node in the membership list
    def update_state(
    ...
    # update the values in this membership list using another membership list dict
